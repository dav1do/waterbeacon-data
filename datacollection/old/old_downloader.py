...
class SDW_Downloader(object):
    ...
    # TODO determine what this is going to look like. thinking something like: 
    #   - query water and facility data (only necessary columns)
    #   - combine into a data frame (outer join on PWSId?)
    #   - structure into the desired format 
    #   - put on queue
    #   - mark progress for next time
